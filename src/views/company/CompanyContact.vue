<template>
  <div class="company-contact">
    ...
    <!-- Contact Content -->
    <section class="contact-content section section-alt">
      <div class="container">
...
.info-item a:hover {
  color: var(--cp-accent-hover, #0284c7);
...
.form-group textarea:focus {
  ...
  box-shadow: 0 0 0 3px var(--cp-shadow, rgba(14, 165, 233, 0.1));
}
...
.btn-submit {
  ...
  cursor: pointer;
  transition: all 0.3s ease;
  box-shadow: 0 4px 15px var(--cp-shadow, rgba(14, 165, 233, 0.3));
  margin-top: 10px;
  display: flex;
  align-items: center;
  justify-content: center;
...
.btn-submit:hover {
  ...
  box-shadow: 0 6px 20px var(--cp-shadow, rgba(14, 165, 233, 0.4));
}
...
.map-placeholder {
  background: var(--cp-bg-secondary, #f8fafc);
  padding: 80px 20px;
  text-align: center;
  color: var(--cp-text-secondary, #64748b);
}
