export const staticProjectsData = [
  {
    ...
    description: "1. Bentuk \"F.I\"\n\nHuruf F.I diambil dari huruf awal dan akhir kata FoSSEI, menggambarkan identitas kuat organisasi serta semangat kontinuitas dari awal hingga akhir dalam menjalankan visi ekonomi Islam.\nBentuk geometrisnya menampilkan kesan modern, tegas, dan kokoh, melambangkan arah dan tujuan yang jelas.\n\n2. Setengah Lingkaran Menutup ke Bawah\n\nMelambangkan persatuan dan sinergi, bahwa dalam acara Rakereg FoSSEI ini banyak fakultas yang berkolaborasi dan bekerja sama demi kelancaran kegiatan.\nBentuk setengah lingkaran juga memberi makna naungan dan kebersamaan, di mana setiap elemen bergerak dalam satu wadah yang sama.\n\n3. Sayap Hijau\n\nSimbol harapan dan perluasan peran FoSSEI ke masa depan.\nMaknanya: semoga acara ini dapat melebarkan sayap FoSSEI untuk memberi dampak positif bagi negeri dan generasi mendatang.\nSayap juga mencerminkan semangat, kebebasan berpikir, dan gerak maju yang dinamis.\n\nMakna Warna\nBiru\n\nMelambangkan ketenangan dan kedamaian — cerminan dari pemikiran yang jernih dan komunikasi yang harmonis antar anggota.\n\nBiru Gradasi ke Terang\n\nMelambangkan regenerasi yang damai, bahwa setiap pergantian kepengurusan dan langkah baru FoSSEI dilakukan dengan semangat positif dan tanpa konflik.\n\nHijau Gradasi ke Terang\n\nMelambangkan pertumbuhan dan kemajuan, bahwa dengan adanya kedamaian dan keseimbangan, akan lahir kemajuan bagi bangsa dan ekonomi Islam.\n\nKesimpulan\n\nLogo ini menggabungkan identitas (F.I), kebersamaan (lingkaran), dan harapan (sayap) dalam satu kesatuan visual yang harmonis.\nWarna dan bentuknya dipilih untuk mencerminkan visi FoSSEI yang damai, progresif, dan berdaya bagi negeri.",
    longDescription: "1. Bentuk \"F.I\"\n\nHuruf F.I diambil dari huruf awal dan akhir kata FoSSEI, menggambarkan identitas kuat organisasi serta semangat kontinuitas dari awal hingga akhir dalam menjalankan visi ekonomi Islam.\nBentuk geometrisnya menampilkan kesan modern, tegas, dan kokoh, melambangkan arah dan tujuan yang jelas.\n\n2. Setengah Lingkaran Menutup ke Bawah\n\nMelambangkan persatuan dan sinergi, bahwa dalam acara Rakereg FoSSEI ini banyak fakultas yang berkolaborasi dan bekerja sama demi kelancaran kegiatan.\nBentuk setengah lingkaran juga memberi makna naungan dan kebersamaan, di mana setiap elemen bergerak dalam satu wadah yang sama.\n\n3. Sayap Hijau\n\nSimbol harapan dan perluasan peran FoSSEI ke masa depan.\nMaknanya: semoga acara ini dapat melebarkan sayap FoSSEI untuk memberi dampak positif bagi negeri dan generasi mendatang.\nSayap juga mencerminkan semangat, kebebasan berpikir, dan gerak maju yang dinamis.\n\nMakna Warna\nBiru\n\nMelambangkan ketenangan dan kedamaian — cerminan dari pemikiran yang jernih dan komunikasi yang harmonis antar anggota.\n\nBiru Gradasi ke Terang\n\nMelambangkan regenerasi yang damai, bahwa setiap pergantian kepengurusan dan langkah baru FoSSEI dilakukan dengan semangat positif dan tanpa konflik.\n\nHijau Gradasi ke Terang\n\nMelambangkan pertumbuhan dan kemajuan, bahwa dengan adanya kedamaian dan keseimbangan, akan lahir kemajuan bagi bangsa dan ekonomi Islam.\n\nKesimpulan\n\nLogo ini menggabungkan identitas (F.I), kebersamaan (lingkaran), dan harapan (sayap) dalam satu kesatuan visual yang harmonis.\nWarna dan bentuknya dipilih untuk mencerminkan visi FoSSEI yang damai, progresif, dan berdaya bagi negeri.",
    date: "1/1/2021",
  ...
  {
    id: "bangalexzz-mie-ayam-landing",
    title: "Bangalexzz Mie Ayam Landing Page",
    category: "landing-page",
    image: "https://images.unsplash.com/photo-1609501676725-7186f17a22da?h=800&w=800&auto=format&crop=entropy",
    thumb: "https://images.unsplash.com/photo-1609501676725-7186f17a22da?h=400&w=400&auto=format&crop=entropy",
    description: "Redesign Phase 5c: Landing page modern Tailwind CSS dengan full Indonesian localization. Mi dicukil tangan, kaldu 24jam, pricing Rp 75K-95K. Sticky header, 2-column hero, features cards, menu grid, location map.",
    longDescription: "Landing Page Phase 5c - Modern Tailwind Design Pattern\n\n✨ Fitur Utama (Phase 5c):\n• Header sticky dengan backdrop-blur & responsive nav\n• Hero section 2-column dengan animated badge\n• 3 feature cards: Mi Dicukil, Rempah Organik, Ayam Segar\n• Menu grid 3-item dengan image overlays & Rp pricing\n• Location section dark dengan map & contact info\n• Full Indonesian localization: \"Cerita Kami\", \"Lokasi\", \"Pesan Sekarang\"\n\n🍜 Menu & Pricing (Rp Format):\n• Mie Ayam Komplit - Rp 75K\n• Mi Ayam Pangsit Spesial - Rp 85K\n• Mi Ayam Extra Telur - Rp 95K (BARU)\n\n🎨 Design Phase 5c:\n• Tailwind CSS modern pattern (#13eca4 primary)\n• Plus Jakarta Sans typography\n• Sticky backdrop-blur header\n• Floating animated badge (bounce 3s)\n• Material Symbols icons\n• Smooth transitions & hover effects\n\n📊 Statistics & Trust:\n• 15k+ Pelanggan Puas\n• 4.9 Rating Google\n• 100% Halal Tersertifikasi\n• Jl. Raya Kraton No. 123, Surabaya\n• Contact: 085155043133\n\n💡 Responsive & Accessible:\n• Mobile-first approach\n• Breakpoints: md (768px), lg (1024px)\n• Full Indonesian UX\n• Modern animations\n• Bangalexzz brand consistency\n\n📱 Fully responsive Tailwind design dengan Phase 5c standards",
    date: "1/1/2026",
    tools: ["HTML5", "Tailwind CSS", "JavaScript"],
    tags: ["Landing Page", "F&B", "Restaurant", "Responsive"],
    gallery: [
  ...
  },
  {
    ...
    category: "landing-page",
    image: "https://images.unsplash.com/photo-1626082927389-6cd097cdc6ec?h=800&w=800&auto=format&crop=entropy",
    thumb: "https://images.unsplash.com/photo-1626082927389-6cd097cdc6ec?h=400&w=400&auto=format&crop=entropy",
    description: "Redesign Phase 5c: Landing page heritage Tailwind dengan interactive menu builder. 4-step wizard (Nasi→Protein→Sayuran→Sambal), 4 nasi options, Rp 45K estimated. Bento-grid menu, testimonials, location map.",
    longDescription: "Landing Page Phase 5c - Interactive Menu Builder + Heritage Aesthetic\n\n✨ Fitur Unggulan Phase 5c:\n• Header sticky dengan rice_bowl icon & responsive nav\n• Hero section 2-column reversed (image right)\n• Floating \"Tingkat Kepedasan\" badge dengan fire icon\n• Bento-style asymmetric menu grid (featured 2x2 + singles)\n• INTERACTIVE 4-STEP BUILDER (Seni Mencampur):\n  - Step 1: Pilih Nasi (4 varieties)\n  - Step 2: Pilih Protein\n  - Step 3: Pilih Sayuran\n  - Step 4: Pilih Sambal\n  - Plate preview visualization\n  - Estimated total: Rp 45K\n• Testimonials section (3 reviews, 5-star)\n• Heritage/story section (dark bg #10221c)\n• Location section dengan map\n• Multi-column footer dengan newsletter\n\n🍚 Nasi Options (Indonesian):\n• Nasi Putih - \"Nasi melati wangi\"\n• Nasi Kuning - \"Nasi kunyit santan\"\n• Nasi Merah - \"Nasi beras merah sehat\"\n• Nasi Uduk - \"Nasi kelapa gurih\"\n\n🎨 Design Phase 5c:\n• Tailwind CSS modern pattern\n• Plus Jakarta Sans typography\n• Sticky backdrop-blur header\n• Material Symbols icons\n• Smooth transitions & hover effects\n• Full Indonesian language (全页翻译)\n\n📊 Features & Trust:\n• Interactive builder dengan visualization\n• 200+ customer reviews\n• 4.9/5 rating\n• Heritage storytelling\n• Jl. Raya Kraton No. 123, Surabaya\n• Contact: 085155043133\n\n💡 Responsive & Engaging:\n• Mobile-first approach\n• Interactive user experience\n• Customization focus (spice levels, ingredients)\n• Heritage connection\n• Modern Tailwind design\n\n📱 Fully responsive dengan interactive elements",
    date: "1/1/2026",
    tools: ["HTML5", "Tailwind CSS", "JavaScript"],
    tags: ["Landing Page", "F&B", "Restaurant", "Redesign"],
    gallery: [
  ...
  },
  {
    ...
    category: "landing-page",
    image: "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?h=800&w=800&auto=format&crop=entropy",
    thumb: "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?h=400&w=400&auto=format&crop=entropy",
    description: "Redesign Phase 5c: Landing page dark modern Tailwind dengan \"Presisi Sempurna\" theme. Technical specs (100°C, 6min steam), Rp pricing (Rp 75K-350K), bento-grid menu, premium positioning.",
    longDescription: "Landing Page Phase 5c - Premium Dark Modern Theme\n\n✨ Fitur Utama Phase 5c:\n• Header sticky dark theme dengan restaurant icon\n• Hero section dark (neutral-dark) dengan gradient overlay\n• Specs strip: Bahan Organik, 100°C Presisi, 6 Menit Uap, Keranjang Bambu\n• Culinary Specs Grid (3-column):\n  - Dilipat Tangan (18 lipatan per dimsum)\n  - Uap Presisi (100°C, 6 menit otomatis)\n  - Bahan Organik (lokal berkelanjutan, blockchain-tracked)\n• The Collection Grid (bento-style asymmetric):\n  - Featured (2x2): Crystal Shrimp (Har Gow) - Rp 105K\n  - Items (1x1): Siu Mai Truffle - Rp 95K, Char Siu Bao - Rp 75K\n  - Wide (2x1): Xiao Long Bao Flight - Rp 125K\n• Newsletter CTA (gradient background)\n• Professional footer with links\n\n🍜 Menu dengan Rp Pricing:\n• Crystal Shrimp (Har Gow) - Rp 105K\n• Siu Mai Truffle - Rp 95K\n• Char Siu Bao - Rp 75K\n• Xiao Long Bao Flight - Rp 125K\n\n🎨 Design Phase 5c:\n• Dark theme: #0d1b17 (neutral-dark) background\n• #13eca4 primary accent (teal/mint)\n• Tailwind CSS modern pattern\n• Material Symbols icons\n• Card hover effects (border-primary/20)\n• Image scale-110 on hover\n• Smooth transitions (300ms)\n\n📊 Premium Positioning:\n• Technical precision messaging\n• Premium ingredient sourcing\n• Artisanal handmaking process\n• Jl. Raya Kraton No. 123, Surabaya\n• Contact: 085155043133\n• Bangalexzz branding consistent\n\n💡 Full Indonesian Language:\n• \"Menu Pilihan\" (Menu Collection)\n• \"Cerita Kami\" (Our Story)\n• \"Pesan Sekarang\" (Order Now)\n• Technical terms in Indonesian\n\n📱 Fully responsive dengan premium dark aesthetic",
    date: "1/1/2026",
    tools: ["HTML5", "Tailwind CSS", "JavaScript", "Unsplash API"],
    tags: ["Landing Page", "F&B", "Dimsum", "Modern Layout"],
    gallery: [
  ...
  },
  {
    ...
    category: "landing-page",
    image: "https://images.unsplash.com/photo-1551632786-de41ec802fcf?h=800&w=800&auto=format&crop=entropy",
    thumb: "https://images.unsplash.com/photo-1551632786-de41ec802fcf?h=400&w=400&auto=format&crop=entropy",
    description: "Redesign Phase 5c: Landing page playful Tailwind dengan pink-yellow vibrant. \"Dimsum yang Bikin TERTAWA\" theme, 12-item menu grid, Rp 45K-125K, fun animations, engagement-focused.",
    longDescription: "Landing Page Phase 5c - Playful Fun Engagement Theme\n\n✨ Fitur Utama Phase 5c:\n• Header sticky dengan rice_bowl icon & playful animations\n• Navigation dengan gradient buttons\n• Hero section vibrant dengan blob shapes & floating badge\n• \"Dimsum yang Bikin TERTAWA\" - Playful positioning\n• Features Grid (3-column):\n  - Rasa yang Ngakak (combinations unexpected but delicious)\n  - Warna-warni Cerah (Instagram-worthy visuals)\n  - Harga Terjangkau (friendly pricing)\n• Menu Grid (12-item):\n  - 4 rows × 3 columns responsive layout\n  - Each item dengan image, title, description, Rp pricing, add button\n  - Color-coded cards (pink/yellow/orange gradients)\n• Newsletter/Call to action (colorful section)\n• Footer dengan social links\n\n🍜 Menu dengan Rp Pricing:\n• Shrimp Dimsum Rainbow - Rp 95K (Top Pick)\n• Pork Bun Creamy - Rp 75K\n• Veggie Dimsum Crunchy - Rp 65K (New!)\n• Chicken Siu Mai Spicy - Rp 75K\n• Dumpling Udang Lumer - Rp 85K\n• Egg Tart Crispy - Rp 45K\n• Mushroom Dumpling - Rp 65K\n• Beef Dimsum Juicy - Rp 95K\n• Scallop Dimsum Mewah - Rp 125K\n• Fish Ball Bouncy - Rp 55K\n• Dessert Dimsum Manis - Rp 45K\n• + 1 additional item\n\n🎨 Design Phase 5c:\n• Vibrant gradient background (amber-pink-orange)\n• Playful pink & yellow color scheme\n• Rounded-3xl cards dengan pink-200 borders\n• Animated floating elements\n• Material Symbols icons\n• Emoji integration (wink, heart, star faces)\n• Smooth bounce & scale animations\n\n📊 Engagement Focus:\n• Young audience targeting\n• Fun & positive tone\n• Interactive hover effects\n• Call-to-action prominence\n• Social-media shareable design\n• Jl. Raya Kraton No. 123, Surabaya\n• Contact: 085155043133\n\n💡 Full Indonesian + Playful Copy:\n• \"Menu Seru\" (Fun Menu)\n• \"Pesan Yuk!\" (Let's Order!)\n• \"Dimsum yang Bikin TERTAWA\" (Dimsum That Makes You Laugh)\n• Emojis throughout\n• Playful tone (not formal)\n\n📱 Fully responsive dengan maximum engagement",
    date: "1/1/2026",
    tools: ["HTML5", "Tailwind CSS", "JavaScript", "CSS Animations"],
    tags: ["Landing Page", "F&B", "Dimsum", "Playful Design", "Animation"],
    gallery: [
  ...
  },
  {
    ...
    category: "landing-page",
    image: "https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?h=800&w=800&auto=format&crop=entropy",
    thumb: "https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?h=400&w=400&auto=format&crop=entropy",
    description: "Redesign Phase 5c: Landing page ultra-premium Tailwind dengan dark luxury theme. \"Dimsum Prestige Eksklusif\" positioning, Rp 220K-350K, glass morphism, gold accents, concierge service messaging.",
    longDescription: "Landing Page Phase 5c - Ultra-Premium Luxury Theme\n\n✨ Fitur Premium Phase 5c:\n• Header sticky dark luxury dengan restaurant_2 icon\n• \"Bangalexzz Prestige Dimsum\" branding\n• Navigation dengan uppercase tracking & luxury styling\n• Hero section split layout (reversed image right):\n  - Elegant headline: \"DIMSUM PRESTIGE\"\n  - Subtitle: \"Pengalaman kuliner kanton eksklusif\"\n  - Stats border-left gold: 1987 (tradition), 5 bintang, 24/7 concierge\n  - CTAs: \"Pesan Meja\", \"Lihat Koleksi Lengkap\"\n• The Masterpiece Collection (4-item grid):\n  - Item 1: Xiao Long Bao Royal - Rp 250K (6 pcs)\n  - Item 2: Har Gow Prestige - Rp 220K (4 pcs)\n  - Item 3: Siu Mai Truffle Gold - Rp 280K (4 pcs)\n  - Item 4: Scallop Dimsum Mewah - Rp 350K (3 pcs)\n• Experience Section (Heritage storytelling)\n• 4 Why Us feature cards:\n  - Jaminan Harga Purba\n  - Persiapan Segar Setiap Hari\n  - Bahan Impor Premium\n  - Peradaban Kuliner\n• Testimonials (3 prestigious reviews with 5 stars)\n• Reservation CTA (phone & email)\n• Footer dengan professional tone\n\n🏆 Masterpiece Collection with Rp Pricing:\n• Xiao Long Bao Royal (Kupuk tangan, jus kepiting harim) - Rp 250K\n• Har Gow Prestige (Kulit bening, udang tiger premium) - Rp 220K\n• Siu Mai Truffle Gold (Kurobuta, telur asli, truffle hitam) - Rp 280K\n• Scallop Dimsum Mewah (Hokkaido, butter ganache, kaviar Beluga) - Rp 350K\n\n🎨 Design Phase 5c:\n• Dark luxury background (#0f1419 to #1a1f2e gradient)\n• Gold accents (#d4af37 / amber-400)\n• Glass morphism: backdrop-blur + rgba backgrounds\n• Shimmer animations (3s ease-in-out)\n• Float animations (smooth floating effect)\n• Plus Jakarta Sans typography with tracking\n• Material Symbols icons\n• Border-l-2 luxury-gold for elegant lists\n\n📊 Ultra-Premium Positioning:\n• 37-year tradition (since 1987)\n• Michelin Guide appreciation\n• Bahan-bahan import premium (Hokkaido, Beluga caviar, truffle)\n• Concierge service 24/7\n• Limited seating messaging\n• Reservation-focused (not walk-in)\n• Jl. Raya Kraton No. 123, Surabaya\n• Contact: 085155043133 (whatsapp centric)\n\n💡 Full Indonesian + Elegance:\n• \"Koleksi\" (Collection)\n• \"Warisan\" (Heritage)\n• \"Reservasi\" (Reservation)\n• \"Pesan Meja\" (Book Table)\n• Premium tone (formal, respectful)\n• Storytelling focus (generational excellence)\n\n👑 Sophisticated Features:\n• Floating badge: \"Keahlian Kuliner Generasi 3\"\n• Testimonials from food critics & chefs\n• Premium ingredient sourcing details\n• Exclusive limited edition mention\n• Personal concierge messaging\n• Reserve system prominence\n\n📱 Sophisticated responsive design untuk discerning audience",
    date: "1/1/2026",
    tools: ["HTML5", "Tailwind CSS", "JavaScript", "Glass Morphism"],
    tags: ["Landing Page", "F&B", "Dimsum", "Luxury Design", "Premium"],
    gallery: [
  ...
  },
  {
    ...
    category: "landing-page",
    image: "https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?h=800&w=800&auto=format&crop=entropy",
    thumb: "https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?h=400&w=400&auto=format&crop=entropy",
  ...
  },
  {
    ...
    category: "landing-page",
    image: "https://images.unsplash.com/photo-1552321554-5fefe8c9ef14?h=800&w=800&auto=format&crop=entropy",
    thumb: "https://images.unsplash.com/photo-1552321554-5fefe8c9ef14?h=400&w=400&auto=format&crop=entropy",
  ...
  },
  {
    ...
    category: "landing-page",
    image: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?h=800&w=800&auto=format&crop=entropy",
    thumb: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?h=400&w=400&auto=format&crop=entropy",
  ...
  },
  {
    ...
    category: "landing-page",
    image: "https://images.unsplash.com/photo-1497366216548-37526070297c?h=800&w=800&auto=format&crop=entropy",
    thumb: "https://images.unsplash.com/photo-1497366216548-37526070297c?h=400&w=400&auto=format&crop=entropy",
